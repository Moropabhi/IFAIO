...
if (strFile)
{
    DX_SPRINTF_S(strBuffer, BUFFER_SIZE, STR_FMT_SPEC DX_STR_WRAP("(") STR_FMT_SPEC DX_STR_WRAP("): "), strFile, strBufferLine);
...
DX_SPRINTF_S(strBufferError, 256, STR_FMT_SPEC DX_STR_WRAP(" (0x%0.8x)"), DX_GETERRORSTRING(hr), hr);
